...
import feedbackImg from "../assets/swiper-img/feedback.jpg";
...
import s9 from "../assets/swiper-img/car.jpg";
...
const images = [s1, s2, s3, s4, s5, s6, s7, s8, s10, s11, s12, s13, s14];
